...
<!--                            --><?php//= Html::img('/template/img/post/post_1.png') ?>
...
<!--                        </div>-->
<!--                        <div class="media post_item">-->
<!--                            --><?php// Html::img('/template/img/post/post_2.png') ?>
<!--                            <div class="media-body">-->
<!--                                <a href="--><?//= Url::toRoute(['single-blog']) ?><!--">-->
...
<!--                        </div>-->
<!--                        <div class="media post_item">-->
<!--                            --><?php// Html::img('/template/img/post/post_3.png') ?>
<!--                            <div class="media-body">-->
<!--                                <a href="--><?php //Url::toRoute(['single-blog']) ?><!--">-->
