...
/**
 * DestinationSearch represents the model behind the search form of `common\models\Destinations`.
 */
class DestinationSearch extends Destinations
{
    ...
    {
        return [
            [['id', 'is_banner', 'status', 'created_at', 'updated_at'], 'integer'],
            [['title_uz', 'title_ru', 'title_en', 'wallpaper'], 'safe'],
        ];
    }
