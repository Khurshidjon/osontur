...
use frontend\modules\admin\models\TelegramUserSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * TgUserController implements the CRUD actions for TelegramUser model.
 */
class TgUserController extends Controller
{
    ...
    {
        if (($model = TelegramUser::findOne(['id' => $id])) !== null) {
            return $model;
        }
