        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                ...
                <div class="card classic-admin-card primary-color">
                    ...
                    <div class="progress">
                        <div class="progress-bar bg grey darken-3" role="progressbar" style="width: 25%"
                             aria-valuenow="25"
                             aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xl-3 col-md-6 mb-md-0 mb-4">
                ...
                <div class="card classic-admin-card light-blue lighten-1">
                    ...
                    <div class="progress">
                        <div class="progress-bar bg grey darken-4" role="progressbar" style="width: 75%"
                             aria-valuenow="75"
                             aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xl-3 col-md-6 mb-0">
                ...
                <div class="card classic-admin-card red accent-2">
                    ...
                    <div class="progress">
                        <div class="progress-bar bg grey darken-4" role="progressbar" style="width: 25%"
                             aria-valuenow="25"
                             aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="card-body">
